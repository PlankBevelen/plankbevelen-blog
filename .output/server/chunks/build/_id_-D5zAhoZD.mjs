        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (tocItems.value.length > 0) {
              _push2(`<ul class="toc-list" data-v-9915725f${_scopeId}><!--[-->`);
              ssrRenderList(tocItems.value, (item, i) => {
                _push2(`<li class="${ssrRenderClass(["toc-item", "lvl-" + item.level])}" data-v-9915725f${_scopeId}><span class="text" data-v-9915725f${_scopeId}>${ssrInterpolate(item.title)}</span></li>`);
              });
              _push2(`<!--]--></ul>`);
            } else {
              _push2(`<a class="toTop" href="#" data-v-9915725f${_scopeId}>${ssrInterpolate(_ctx.$t("toc.toTop"))}</a>`);
            }
          } else {
            return [
...
const Toc = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-9915725f"]]), { __name: "ArticleToc" });
...
//# sourceMappingURL=_id_-D5zAhoZD.mjs.map
