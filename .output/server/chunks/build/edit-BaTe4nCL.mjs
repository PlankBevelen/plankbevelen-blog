...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "article-edit" }, _attrs))} data-v-83b43180><div class="header" data-v-83b43180><h2 class="title" data-v-83b43180>${ssrInterpolate(pageTitle.value)}</h2><div class="ops" data-v-83b43180>`);
      ...
      _push(`</div></div><div class="editor-layout" data-v-83b43180>`);
      _push(ssrRenderComponent(_component_el_card, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-83b43180${_scopeId}>文章设置</span>`);
          } else {
            return [
...
const edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-83b43180"]]);

export { edit as default };
//# sourceMappingURL=edit-BaTe4nCL.mjs.map
